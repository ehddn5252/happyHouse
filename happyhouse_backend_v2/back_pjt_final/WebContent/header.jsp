...
<!-- 메뉴바 만들기 -->
<!--  background 수정 -->
<header id="header" class="fixed-top" style="background-color:rgba(184,134,011,0.8)">
<!--수정한 부분  -->
        ...
        <div class="logo me-auto">
          <h1 class="text-light">
            <a href="index.jsp"
              ><span>
              <!--수정한 부분  -->
                Happy<span id="logo-a " style="color: rgba(255,255,0,1); font-size: 26px"
                  >House</span
                ></span
              ></a
            >
      ...
      <!-- 수정한 부분  -->
        <nav id="navbar" class="navbar navbar-dark order-last order-lg-0">
          <ul>
          
            <li ><a class="nav-link scrollto" href="index.jsp" >홈</a></li>
            <li><a class="nav-link scrollto" href="index.jsp">회사 소개</a></li>
        ...
        <div class="dropdown dropdown-menu-right info-btn-container loginOnly">
          <a class="log-btn dropdown-toggle btn-default btn-sm flip" style="background-color:rgba(255, 215, 0,0.8); color:rgb(0,0,0)" data-bs-toggle="dropdown">
            회원 정보
          </a>
          <div
            class="dropdown-menu dropdown-menu-end dropdown-animation panel form info-container show"
            style="display: none; background-color:rgba(255, 215, 0,0.8);" 
          >
            <a class="mypage-btn" href="user?act=mvmypage">마이페이지</a>
            <button class="btn mypage-btn" onclick="location.href='user?act=logout'" type="button">로그아웃</button>
          </div>
        </div>
        ...
        <div class="dropdown dropdown-menu-right log-btn-container logoutOnly">
          ...
          >
            <form class="login-form">
              ...
              <button type="submit" class="login-btn" id="login-btn" style="background-color:rgba(0,0,0,1)">로그인</button>
              <div id="error-msg"> </div>
              <div class="bottom-text">
                <p class="mt-2 mb-2">
                  Don’t have account ? <a href="user?act=mvregister">회원가입</a> <br />
                </p>
                <p class="mt-2 mb-2">
                  Forget your password ?
                  <a href="user?act=mvfindpwd">비밀번호 찾기</a>
                </p>
              </div>
            </form>
          </div>
